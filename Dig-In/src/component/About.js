      ...
      <div className="about-sec">
        <div className="about-main">
          ...
          <div className="about-main-text">
            <h1>Dig In - Discover the best food & drinks</h1>
            <p>
             Dig In is an online and mobile food ordering system which we
              have developed for restaurant owners and food lovers. Through
              Dig In, we are helping customers to discover the best restaurants
